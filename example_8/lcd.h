...
/*     Write a NULL-TERMINATED string on  the LCD                           */
/*                                                                          */
/*  Parameters :                                                            */
/*     str        - Pointer to a NULL-TERMINATED string                     */
/*     x          - Initial page (row). Range [0, 131]                      */
/*     y          - Initial column. Range [0, 131]                          */
/*     FG_color   - text color, RGB color 12-bit (0000RRRRGGGGBBBB)         */
/*     BG_color   - back color, RGB color 12-bit (0000RRRRGGGGBBBB)         */
/*                                                                          */
/****************************************************************************/

void LCD_DisplayString (const uint8_t *str, uint8_t x, uint8_t y, unsigned short FG_color, unsigned short BG_color);
